...
import { ObjectSearchResult, PatchFilterOptions } from "../interfaces";
...
export declare function search(haystack: object, needle: string | number, method?: ObjectSearch): ObjectSearchResult | null;
